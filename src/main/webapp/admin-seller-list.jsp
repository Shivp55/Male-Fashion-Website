...
<title>Glance Design Dashboard an Admin Panel Category Flat
	Bootstrap Responsive Website Template | Tables :: w3layouts</title>
...
%>
	...
	<div class="main-content">
						...
						<ul class="sidebar-menu">
							...
							<li class="treeview"><a href="#"> <i
								...
								<ul class="treeview-menu">
									<li><a href="grids.jsp"><i class="fa fa-angle-right"></i>
											Grids</a></li>
									<li><a href="media.jsp"><i class="fa fa-angle-right"></i>
											Media Css</a></li>
								</ul></li>
							<li class="treeview"><a href="charts.jsp"> <i
							...
							<li class="treeview"><a href="#"> <i
								...
								<ul class="treeview-menu">
									<li><a href="general.jsp"><i
											class="fa fa-angle-right"></i> General</a></li>
									<li><a href="icons.jsp"><i class="fa fa-angle-right"></i>
											Icons</a></li>
									<li><a href="buttons.jsp"><i
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h2 class="title1">Sellers Table:</h2>
					<div class="bs-example widget-shadow"
						...
						<thead>
								<tr>
									...
									<th align="center">Total Products Uploaded</th>
							...
							<%
							List<Seller> list = SellerDao.getAllSeller();
							%>
							<% 	
							for (Seller s : list) {
							int id=s.getId();
							int i=ProductDao.getAllProductsBySid(id);%>
				...
				<div class="tables">
					<br>
					<h2 class="title1">Customers Table:</h2>
					<div class="bs-example widget-shadow"
						data-example-id="hoverable-table">
						<h4></h4>
						<table class="table table-hover">
						<thead>
							...
							<%
							List<Customer> list2 = CustomerDao.getAllCustomer();
							%>
							<% 	
