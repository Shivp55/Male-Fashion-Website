...
function drawChart() { 
 var data = google.visualization.arrayToDataTable([
	 ['Activities', 'Total'],
	 <%int cu=CustomerDao.getAllCustomers();%>
	 <%int se=SellerDao.getAllSellers();%>
	 <%int pro=ProductDao.getAllProductss();%>
	 ['Customers', <%=cu%>],
	 ['Sellers', <%=se%>],
	 ['Total Products Uploaded', <%=pro%>],
	 ['Scarves', 20] 
	 ]);
				...
				<div class="col_3">
					<div class="col-md-3 widget widget1">
						<div class="r3_counter_box">
							<i class="pull-left fa fa-users dollar2 icon-rounded" style="background-color:lightblue;color:green;"></i>
							<div class="stats">
								<h5>
								<%int sellers=SellerDao.getAllSellers(); %>
							<strong><%out.print(sellers); %></strong>
					...
					<div class="col-md-3 widget widget1">
						<div class="r3_counter_box">
							...
							<div class="stats">
								<h5>
								<%int customer=CustomerDao.getAllCustomers(); %>
			...
			<div class="clearfix"></div>
				...
				<div class="row-one widgettable">
					<div class="col-md-7 content-top-2 card" >
						<div class="agileinfo-cdr">
							<div class="card-header">
								<h3>Admin Perspectives</h3>
							</div>
								
								
								<div id="chart1"  style="width:98%;height:350px;" ></div>
					...
					<div class="col-md-3 stat">
						...
						<div class="content-top-1">
							<div class="col-md-6 top-content">
							<%int reviews=ReviewDao.allReviews(); %>
								<h5>Reviews</h5>
							...
							<div id="owl-demo" class="owl-carousel text-center">
								<div class="item">
									<img class="lazyOwl img-responsive"
										data-src="admin/images/slider1.jpg" alt="name">
								</div>
								<div class="item">
+									<img class="lazyOwl img-responsive"
										data-src="admin/images/slider2.jpg" alt="name">
								</div>
								<div class="item">
									<img class="lazyOwl img-responsive"
										data-src="admin/images/slider3.jpg" alt="name">
								</div>
								<div class="item">
									<img class="lazyOwl img-responsive"
										data-src="admin/images/slider4.jpg" alt="name">
								</div>
								<div class="item">
									<img class="lazyOwl img-responsive"
										data-src="admin/images/slider5.jpg" alt="name">
								</div>
								<div class="item">
									<img class="lazyOwl img-responsive"
										data-src="admin/images/slider6.jpg" alt="name">
								</div>
								<div class="item">
									<img class="lazyOwl img-responsive"
										data-src="admin/images/slider7.jpg" alt="name">
								</div>
