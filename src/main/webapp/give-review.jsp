                ...
                <div class="col-lg-6 col-md-6">
                    <div class="contact__text">
                        <div class="section-title">
                            <h2>Review Us</h2>
                             <h4>
                        <%String review=(String)request.getAttribute("reviewed"); %>
                        <%if(review!=null){
                        	out.print(review);	
                        ...
                        <form action="ReviewController" method="post">
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" placeholder="Please Review Us" name="review">
                                    <button type="submit" name="action" class="site-btn" value="Submit">Submit</button>
                                </div>
                            </div>
                        </form>
                                           </div>
